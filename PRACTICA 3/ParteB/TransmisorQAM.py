...
from ArizaValestEnvolventeComplejaDSBSC import ArizaValestEnvolventeComplejaDSBSC  # grc-generated hier_block
...
class TransmisorQAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ArizaValestEnvolventeComplejaDSBSC_0 = ArizaValestEnvolventeComplejaDSBSC(
            Ac=Ac,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ArizaValestEnvolventeComplejaDSBSC_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ArizaValestEnvolventeComplejaDSBSC_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ArizaValestEnvolventeComplejaDSBSC_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ArizaValestEnvolventeComplejaDSBSC_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.ArizaValestEnvolventeComplejaDSBSC_0, 1))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ArizaValestEnvolventeComplejaDSBSC_0.set_Ac(self.Ac)
