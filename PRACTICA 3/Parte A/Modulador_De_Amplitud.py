...
from ModuladorAM_B1B_G3 import ModuladorAM_B1B_G3  # grc-generated hier_block
...
class Modulador_De_Amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ka_range = Range(0, 1, 1, 1, 200)
        self._ka_win = RangeWidget(self._ka_range, self.set_ka, "habilita portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 100, 1e-3, 125e-3, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Documentos/Báilame-Despacio.wav', True)
        self.blocks_complex_to_real_0 = blocks.complex_to_real(1)
        self.ModuladorAM_B1B_G3_0 = ModuladorAM_B1B_G3(
            Ac=Ac,
            ka=1,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModuladorAM_B1B_G3_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.ModuladorAM_B1B_G3_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ModuladorAM_B1B_G3_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModuladorAM_B1B_G3_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.CalculoPComunicaciones_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.rational_resampler_xxx_0, 0))
        self.connect((self.rational_resampler_xxx_0, 0), (self.ModuladorAM_B1B_G3_0, 0))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ModuladorAM_B1B_G3_0.set_Ac(self.Ac)
