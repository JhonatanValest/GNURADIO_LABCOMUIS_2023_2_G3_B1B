...
from ArizaValestModuladorSSB import ArizaValestModuladorSSB  # grc-generated hier_block
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ArizaValestModuladorSSB_0 = ArizaValestModuladorSSB(
            Ac=Ac,
            B=B,
            k=K,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ArizaValestModuladorSSB_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ArizaValestModuladorSSB_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ArizaValestModuladorSSB_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ArizaValestModuladorSSB_0, 0))
    ...
    def set_K(self, K):
        self.K = K
        self.ArizaValestModuladorSSB_0.set_k(self.K)
    ...
    def set_B(self, B):
        self.B = B
        self.ArizaValestModuladorSSB_0.set_B(self.B)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ArizaValestModuladorSSB_0.set_Ac(self.Ac)
