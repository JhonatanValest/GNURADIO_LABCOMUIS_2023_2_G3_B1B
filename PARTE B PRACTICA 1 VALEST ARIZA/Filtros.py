...
class Filtros(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Filtros")
        ...
        self.high_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.high_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/y2mate.com-Michael-jackson-Beat-It-Lyrics.wav', True)
...
def main(top_block_cls=Filtros, options=None):
