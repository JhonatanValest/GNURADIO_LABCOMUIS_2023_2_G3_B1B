...
class PruebaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = Range(0, 10000, 10, 0, 200)
        ...
        self.ModulacionPAMG3B1B_0 = ModulacionPAMG3B1B(
            D=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionPAMG3B1B_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAMG3B1B_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModulacionPAMG3B1B_0.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.ModulacionPAMG3B1B_0.set_fs(self.fs)
    ...
    def set_D(self, D):
        self.D = D
        self.ModulacionPAMG3B1B_0.set_D(self.D)
