...
from ModulacionPAMG3B1B import ModulacionPAMG3B1B  # grc-generated hier_block
...
class multiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._D4_win = RangeWidget(self._D4_range, self.set_D4, "Selección señal RX", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.ModulacionPAMG3B1B_0_0_2 = ModulacionPAMG3B1B(
            D=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAMG3B1B_0_0_1 = ModulacionPAMG3B1B(
            D=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAMG3B1B_0_0_0 = ModulacionPAMG3B1B(
            D=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModulacionPAMG3B1B_0_0 = ModulacionPAMG3B1B(
            D=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModulacionPAMG3B1B_0_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModulacionPAMG3B1B_0_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.ModulacionPAMG3B1B_0_0_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModulacionPAMG3B1B_0_0_1, 0), (self.blocks_delay_1, 0))
        self.connect((self.ModulacionPAMG3B1B_0_0_2, 0), (self.blocks_delay_2, 0))
        self.connect((self.ModulacionPAM_0_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.ModulacionPAM_0_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulacionPAMG3B1B_0_0_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.ModulacionPAMG3B1B_0_0, 0))
        self.connect((self.analog_sig_source_x_2, 0), (self.ModulacionPAMG3B1B_0_0_1, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.ModulacionPAMG3B1B_0_0_2, 0))
        ...
        self.connect((self.blocks_delay_0_0_0, 0), (self.ModulacionPAM_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModulacionPAMG3B1B_0_0.set_samp_rate(self.samp_rate)
        ...
        self.ModulacionPAMG3B1B_0_0_0.set_samp_rate(self.samp_rate)
        self.ModulacionPAMG3B1B_0_0_1.set_samp_rate(self.samp_rate)
        self.ModulacionPAMG3B1B_0_0_2.set_samp_rate(self.samp_rate)
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.ModulacionPAMG3B1B_0_0.set_fs(self.fs)
        self.ModulacionPAM_0_0.set_fs(self.fs)
        self.ModulacionPAMG3B1B_0_0_0.set_fs(self.fs)
        self.ModulacionPAMG3B1B_0_0_1.set_fs(self.fs)
        self.ModulacionPAMG3B1B_0_0_2.set_fs(self.fs)
    ...
    def set_D(self, D):
        self.D = D
        self.ModulacionPAMG3B1B_0_0.set_D(self.D)
        self.ModulacionPAM_0_0.set_D(self.D)
        self.ModulacionPAMG3B1B_0_0_0.set_D(self.D)
        self.ModulacionPAMG3B1B_0_0_1.set_D(self.D)
        self.ModulacionPAMG3B1B_0_0_2.set_D(self.D)
