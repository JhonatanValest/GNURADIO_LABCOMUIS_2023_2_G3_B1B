...
from EnvolventeComplejaPMB1B import EnvolventeComplejaPMB1B  # grc-generated hier_block
...
class ModulacionPM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fm_range = Range(1000, 20e3, 100, 1000, 200)
        ...
        self.EnvolventeComplejaPMB1B_0 = EnvolventeComplejaPMB1B(
            Ac=Ac,
            Kp=kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.EnvolventeComplejaPMB1B_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPMB1B_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.EnvolventeComplejaPMB1B_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.EnvolventeComplejaPMB1B_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.EnvolventeComplejaPMB1B_0.set_Kp(self.kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.EnvolventeComplejaPMB1B_0.set_Ac(self.Ac)
